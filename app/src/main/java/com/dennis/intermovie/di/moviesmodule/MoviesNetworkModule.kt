...
import com.dennis.intermovie.data.source.remote.RequestInterceptor
...
class MoviesNetworkModule {
    ...
    @Singleton
    @Provides
    fun provideRetrofitService(okHttpClient: OkHttpClient): InterMovieApiService =
        Retrofit.Builder()
            .baseUrl(InterMovieApiService.BASE_URL)
            .addConverterFactory(
            ...
            .client(okHttpClient)
            .build()
            .create(InterMovieApiService::class.java)
